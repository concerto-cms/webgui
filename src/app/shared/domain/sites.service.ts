...
import {Observable, PublishSubject} from 'rxjs/Observable';
...
export class SitesService {
    getAvailableSitesSubject = new PublishSubject();
    
    constructor(
        private ngRedux: NgRedux<any>,
        private api: ApiService,
    ) {
        this.getAvailableSitesSubject
    ...
    getAvailableSites() {
        this.getAvailableSitesSubject.next();
